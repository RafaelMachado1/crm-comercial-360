...
const formLoginInicial: LoginFormData = {
  email: "",
  senha: "",
};

function LoginPage() {
  const [formLogin, setFormLogin] = useState<LoginFormData>(formLoginInicial);
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!resultado.success) {
      setErroLogin(resultado.message ?? "Erro ao realizar login.");
      return;
    }
